...
@author: SSubhnil
@details: DQN code for Windy GridWorld_v2 - Has 2 convolution layers to help with sparsity.
"""
import math
import random
import matplotlib
...
np.save("DQN-Wind-GW-Step_count-greedy_eval_conv2d_{}.npy".format(experiment_number), step_count)
np.save("DQN-Wind-GW-Greedy_Step_count-greedy_eval_conv2d_{}.npy".format(experiment_number), avg_greedy_step_count)
...
plt.savefig('DQN-Wind-GW-test_conv2d_{}.png'.format(experiment_number), dpi=600)
...
plt.legend()
plt.savefig("DQN-Wind-GW-greedy_episodes_conv2d_{}.png".format(experiment_number), dpi = 600)
