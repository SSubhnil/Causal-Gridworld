# -*- coding: utf-8 -*-
"""
Created on Mon Oct  9 13:48:18 2023

@author: shubh
@details: A2C for King Stochastic Windy GW
"""
...
run = wandb.init(project="A2C-Stoch-King-Windy-GW")#, mode = "disabled")
...
if __name__ == "__main__":
    ...
    plt.title('A2C-King-Stoch-GW alp=%f' % learning_rate_actor)
    plt.legend(loc="upper right")
    plt.savefig('A2C-King-Stoch-GW-h{}_{}.png'.format(hidden_dim, experiment_number), dpi=600)
    ...
    plt.legend()
    plt.savefig("A2C-King-Stoch-GW-greedy_episodes_h{}_{}.png".format(hidden_dim, experiment_number), dpi = 600)
